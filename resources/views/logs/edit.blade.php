                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('logs.update', $log) }}">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="title" name="title" value="{{ old('title', $log->title) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" id="date" name="date" value="{{ old('date', $log->date->format('Y-m-d')) }}" required
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="tags" name="tags" 
                                   value="{{ old('tags', $log->tags->pluck('name')->implode(', ')) }}" 
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="content" name="content" rows="12" 
                                      class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 @error('content') border-red-500 @enderror">{{ old('content', $log->content) }}</textarea>
                            <p class="mt-1 text-sm text-gray-500">Markdown記法で記述できます</p>
                            @error('content')
                                <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                            @enderror
                        </div>
